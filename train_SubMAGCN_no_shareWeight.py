...
parser.add_argument("--config", default="configurations/TAIAN_subMRAGCN_no_shareweight.conf", type=str,
...
net = Enc_Dec(num_for_predict, L_tilde_node=L_tilde_node, dim_in_node=8, dim_out_node=8, adj_sub_edge=adj_edge_sub,
              L_tilde_edge=L_tilde_edge, dim_in_edge=16, dim_out_edge=16, range_K=K, types_accident=types_accident,
              device=DEVICE, in_drop=0.0, gcn_drop=0.0,
              residual=True,share_weight=False)

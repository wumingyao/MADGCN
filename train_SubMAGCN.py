...
net = Enc_Dec(num_for_predict, L_tilde_node=L_tilde_node, dim_in_node=4, dim_out_node=4, adj_sub_edge=adj_edge_sub,
              L_tilde_edge=L_tilde_edge, dim_in_edge=4, dim_out_edge=4, range_K=K, types_accident=types_accident,
...
if __name__ == "__main__":
    train_main()
    # evaluate_on_test_parallel(net, 10, params_path, test_dataset, mean_node, std_node, mean_edge, std_edge,
    #                           batch_size, DEVICE)
